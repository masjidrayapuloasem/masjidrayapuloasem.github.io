...
export function AboutSection() {
  ...
  const showSejarah = settings?.section_sejarah_visible !== "false";
  const showVisiMisi = settings?.section_visimisi_visible !== "false";
  const showKepengurusan = settings?.section_kepengurusan_visible !== "false";
  ...
  // Don't render if all sub-sections are hidden
  if (!showSejarah && !showVisiMisi && !showKepengurusan) return null;
